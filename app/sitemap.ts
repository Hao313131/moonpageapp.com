...
const ROUTE_META: Record<string, { priority: number; changeFrequency: Freq }> = {
  ...
  "/short-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
  "/free-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
  "/sleep-stories-for-kids": { priority: 0.9, changeFrequency: "weekly" },
  "/baby-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
  "/bedtime-routine-chart": { priority: 0.9, changeFrequency: "weekly" },
  "/bedtime-stories-in-your-voice": { priority: 0.9, changeFrequency: "weekly" },
  "/bedtime-stories-for-anxious-kids": { priority: 0.9, changeFrequency: "weekly" },
  "/offline-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
  "/bedtime-stories-for-siblings": { priority: 0.9, changeFrequency: "weekly" },
  "/winter-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
  "/goodnight-bedtime-stories": { priority: 0.9, changeFrequency: "weekly" },
